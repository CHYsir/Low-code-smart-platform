...
namespace LowCodeSmartPlatform.EntityFrameworkCore
{
    ...
    public class LowCodeSmartPlatformDbContext : 
        AbpDbContext<LowCodeSmartPlatformDbContext>,
        IIdentityDbContext,
        ITenantManagementDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            //{
            //    b.ToTable(LowCodeSmartPlatformConsts.DbTablePrefix + "YourEntities", LowCodeSmartPlatformConsts.DbSchema);

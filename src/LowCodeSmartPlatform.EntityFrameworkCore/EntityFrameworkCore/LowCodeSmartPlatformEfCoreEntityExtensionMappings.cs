...
{
    public static class LowCodeSmartPlatformEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE LowCodeSmartPlatformModuleExtensionConfigurator CLASS (in the Domain.Shared project)
